...
import SelectedPlayerInfo from '../Team/SelectedPlayerInfo/SelectedPlayerInfo';
    ...
    return (
        <div className="PlayerSelection">
            ...
            <div className="budget-info">
                ...
                {
                    selectPlayer.map(player => <h5>{player.name} : <span className="justify-content-md-center">{player.sallary}</span></h5>)
                }
                <h4>Total Hire Budget : <span className="num">${totalBudget}</span></h4>
